module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c116 = "first-line",
        peg$c117 = { type: "literal", value: "first-line", description: "\"first-line\"" },
        peg$c118 = "first-letter",
        peg$c119 = { type: "literal", value: "first-letter", description: "\"first-letter\"" },
        peg$c120 = "before",
        peg$c121 = { type: "literal", value: "before", description: "\"before\"" },
        peg$c122 = "after",
        peg$c123 = { type: "literal", value: "after", description: "\"after\"" },
        peg$c124 = "odd",
        peg$c125 = { type: "literal", value: "odd", description: "\"odd\"" },
        peg$c126 = "even",
        peg$c127 = { type: "literal", value: "even", description: "\"even\"" },
        peg$c128 = "n",
        peg$c129 = { type: "literal", value: "n", description: "\"n\"" },
        peg$c130 = function(a, plus) {
                return (a + 'n+') + (plus ? b : '0');
            },
        peg$c131 = "{",
        ...
        peg$c135 = function(body) {
                return body;
            },
        peg$c136 = ";",
        peg$c137 = { type: "literal", value: ";", description: "\";\"" },
        peg$c138 = function(prop, values) {
                return A.pair(prop, values)
            },
        peg$c139 = /^[a-zA-Z\-]/,
        peg$c140 = { type: "class", value: "[a-zA-Z\\-]", description: "[a-zA-Z\\-]" },
        peg$c141 = function(name) {
                return name.join('');
            },
        peg$c142 = function(n, u) {
                return A.value(n, u);
            },
        peg$c143 = ",",
        peg$c144 = { type: "literal", value: ",", description: "\",\"" },
        peg$c145 = function(v) { return parseInt(v, 10); },
        peg$c146 = function(v) { return parseFloat(v); },
        peg$c147 = "cm",
        peg$c148 = { type: "literal", value: "cm", description: "\"cm\"" },
        peg$c149 = "mm",
        peg$c150 = { type: "literal", value: "mm", description: "\"mm\"" },
        peg$c151 = "in",
        peg$c152 = { type: "literal", value: "in", description: "\"in\"" },
        peg$c153 = "pt",
        peg$c154 = { type: "literal", value: "pt", description: "\"pt\"" },
        peg$c155 = "px",
        peg$c156 = { type: "literal", value: "px", description: "\"px\"" },
        peg$c157 = "pc",
        peg$c158 = { type: "literal", value: "pc", description: "\"pc\"" },
        peg$c159 = "deg",
        peg$c160 = { type: "literal", value: "deg", description: "\"deg\"" },
        peg$c161 = "rad",
        peg$c162 = { type: "literal", value: "rad", description: "\"rad\"" },
        peg$c163 = /^[a-zA-Z0-9_\-]/,
        peg$c164 = { type: "class", value: "[a-zA-Z0-9_\\-]", description: "[a-zA-Z0-9_\\-]" },
        peg$c165 = "$",
        peg$c166 = { type: "literal", value: "$", description: "\"$\"" },
        peg$c167 = /^[a-zA-Z_]/,
        peg$c168 = { type: "class", value: "[a-zA-Z_]", description: "[a-zA-Z_]" },
        peg$c169 = /^[a-zA-Z9-9_]/,
        peg$c170 = { type: "class", value: "[a-zA-Z9-9_]", description: "[a-zA-Z9-9_]" },
